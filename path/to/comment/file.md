...
2. **Confirmation dialog** — Before resetting, show a confirmation: "Start a new chart? Any unsaved changes will be lost." with "Cancel" and "New Chart" buttons. If the current chart has been saved (i.e., it matches a saved chart), skip the confirmation.
